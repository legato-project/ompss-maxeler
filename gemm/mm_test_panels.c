...
{
  {
    ...
    int mcc_arg_3 = panelSize;
    {
      ...
      dimensions_0[0].size = (((mcc_arg_3) - 1L - 0L) + 1L) * sizeof(double);
      dimensions_0[0].lower_bound = (0L - 0L) * sizeof(double);
      dimensions_0[0].accessed_length = ((mcc_arg_3) - 1L - 0L - (0L - 0L) + 1) * sizeof(double);
      ...
      dimensions_1[0].size = (((mcc_arg_3) - 1L - 0L) + 1L) * sizeof(double);
      dimensions_1[0].lower_bound = (0L - 0L) * sizeof(double);
      dimensions_1[0].accessed_length = ((mcc_arg_3) - 1L - 0L - (0L - 0L) + 1) * sizeof(double);
      ...
      dimensions_2[0].size = (((mcc_arg_3) - 1L - 0L) + 1L) * sizeof(double);
      dimensions_2[0].lower_bound = (0L - 0L) * sizeof(double);
      dimensions_2[0].accessed_length = ((mcc_arg_3) - 1L - 0L - (0L - 0L) + 1) * sizeof(double);
      ...
      if (nanos_wd_ != (nanos_wd_t)0)
      ...
      else
        {
          ...
          nanos_err = nanos_create_wd_and_run_compact(&nanos_wd_const_data.base, &nanos_wd_dyn_props, sizeof(struct nanos_args_0_t), &imm_args, 3, &dependences[0], imm_copy_data, imm_copy_dimensions, (nanos_translate_args_t)nanos_xlate_fun_mmtestpanelsc_0);
          if (nanos_err != NANOS_OK)
            {
              nanos_handle_error(nanos_err);
            }
